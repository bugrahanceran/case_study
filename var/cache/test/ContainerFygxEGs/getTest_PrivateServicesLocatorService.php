...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Utils\\MomentFormatConverter' => ['privates', 'App\\Utils\\MomentFormatConverter', 'getMomentFormatConverterService', true],
            ...
            'security.user_password_hasher' => ['services', 'test.user_password_hasher', 'getTest_UserPasswordHasherService', true],
            ...
            'html_sanitizer.builder' => ['privates', 'html_sanitizer.builder', 'getHtmlSanitizer_BuilderService', true],
            'html_sanitizer.extension.basic' => ['privates', 'html_sanitizer.extension.basic', 'getHtmlSanitizer_Extension_BasicService', true],
            'html_sanitizer.extension.code' => ['privates', 'html_sanitizer.extension.code', 'getHtmlSanitizer_Extension_CodeService', true],
            'html_sanitizer.extension.image' => ['privates', 'html_sanitizer.extension.image', 'getHtmlSanitizer_Extension_ImageService', true],
            'html_sanitizer.extension.iframe' => ['privates', 'html_sanitizer.extension.iframe', 'getHtmlSanitizer_Extension_IframeService', true],
            'html_sanitizer.extension.list' => ['privates', 'html_sanitizer.extension.list', 'getHtmlSanitizer_Extension_ListService', true],
            'html_sanitizer.extension.table' => ['privates', 'html_sanitizer.extension.table', 'getHtmlSanitizer_Extension_TableService', true],
            'html_sanitizer.extension.extra' => ['privates', 'html_sanitizer.extension.extra', 'getHtmlSanitizer_Extension_ExtraService', true],
            'html_sanitizer.extension.details' => ['privates', 'html_sanitizer.extension.details', 'getHtmlSanitizer_Extension_DetailsService', true],
            'html_sanitizer.registry' => ['privates', 'html_sanitizer.registry', 'getHtmlSanitizer_RegistryService', false],
            'html_sanitizer.default' => ['privates', 'html_sanitizer.default', 'getHtmlSanitizer_DefaultService', true],
            'html_sanitizer.form.text_type_extension' => ['privates', 'html_sanitizer.form.text_type_extension', 'getHtmlSanitizer_Form_TextTypeExtensionService', true],
            'html_sanitizer.twig_extension' => ['privates', 'html_sanitizer.twig_extension', 'getHtmlSanitizer_TwigExtensionService', false],
            ...
            'monolog.logger.html-sanitizer' => ['privates', 'monolog.logger.html-sanitizer', 'getMonolog_Logger_HtmlsanitizerService', true],
            ...
            'security.password_hasher' => ['services', 'test.user_password_hasher', 'getTest_UserPasswordHasherService', true],
            'Symfony\\Component\\PasswordHasher\\Hasher\\UserPasswordHasherInterface' => ['services', 'test.user_password_hasher', 'getTest_UserPasswordHasherService', true],
            ...
            'HtmlSanitizer\\SanitizerInterface' => ['privates', 'html_sanitizer.default', 'getHtmlSanitizer_DefaultService', true],
            'html_sanitizer' => ['privates', 'html_sanitizer.default', 'getHtmlSanitizer_DefaultService', true],
            'HtmlSanitizer\\SanitizerInterface $default' => ['privates', 'html_sanitizer.default', 'getHtmlSanitizer_DefaultService', true],
            'twig.loader.filesystem' => ['privates', 'twig.loader.native_filesystem', 'getTwig_Loader_NativeFilesystemService', false],
            'argument_resolver.controller_locator' => ['privates', '.service_locator.vm.Et4C', 'get_ServiceLocator_Vm_Et4CService', true],
            ...
            'Psr\\Log\\LoggerInterface $htmlSanitizerLogger' => ['privates', 'monolog.logger.html-sanitizer', 'getMonolog_Logger_HtmlsanitizerService', true],
            ...
            'twig.extension.intl' => '?',
            'html_sanitizer.builder' => '?',
            'html_sanitizer.extension.basic' => '?',
            'html_sanitizer.extension.code' => '?',
            'html_sanitizer.extension.image' => '?',
            'html_sanitizer.extension.iframe' => '?',
            'html_sanitizer.extension.list' => '?',
            'html_sanitizer.extension.table' => '?',
            'html_sanitizer.extension.extra' => '?',
            'html_sanitizer.extension.details' => '?',
            'html_sanitizer.registry' => '?',
            'html_sanitizer.default' => '?',
            'html_sanitizer.form.text_type_extension' => '?',
            'html_sanitizer.twig_extension' => '?',
            ...
            'HtmlSanitizer\\SanitizerInterface' => '?',
            'html_sanitizer' => '?',
            'HtmlSanitizer\\SanitizerInterface $default' => '?',
            ...
            'Psr\\Log\\LoggerInterface $htmlSanitizerLogger' => '?',
