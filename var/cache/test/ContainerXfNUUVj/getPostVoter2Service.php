...
class getPostVoter2Service extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['debug.security.voter.App\\Security\\PostVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($container->privates['App\\Security\\PostVoter'] ?? ($container->privates['App\\Security\\PostVoter'] = new \App\Security\PostVoter())), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
    }
}
